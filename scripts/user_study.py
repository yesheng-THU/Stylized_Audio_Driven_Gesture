...
if __name__ == "__main__":
    ...
    bodypose, target = generator_motion.generate_test_sample(built_motion['graph'], eps_std=1.0, step=step, counter=0)
    ...
    create_video_and_save(".", target, bodypose, mean_data, "test",
